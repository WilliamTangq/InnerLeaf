...
export const translations = {
  ...
  zh: {
    ...
    app: {
      ...
      cards: [
        ["快速反思", "自由写下这次情绪时刻，InnerLeaf 会帮你整理。", "开始快速反思", "/quick"],
        ["一步步反思", "用温和结构区分事实、想法、情绪和反应。", "开始引导反思", "/guided"],
        ["反思历史", "回看保存的卡片，并记录哪些下一步有帮助。", "查看历史记录", "/history"],
        ["模式总结", "查看重复触发点、思维模式和有帮助的下一步。", "查看模式总结", "/summary"],
      ],
      recent: "最近的反思",
      noRecent: "还没有保存的反思记录。",
      recentTrigger: "最近触发点",
