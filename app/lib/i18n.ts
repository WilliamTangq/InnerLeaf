...
export const translations = {
  en: {
    ...
    home: {
      ...
      subtitle:
        "InnerLeaf turns intense emotional moments into structured reflection cards — helping you separate facts from interpretation, choose one small next step, and notice patterns over time.",
      safety: "Not therapy. Not diagnosis. Not medical advice.",
      boundary:
      ...
      trustCards: [
        ...
        "No therapy claims",
        "Your reflections are structured, not judged",
      ],
      useCasesEyebrow: "Use cases",
      useCasesTitle: "Built for everyday emotional loops.",
      useCases: [
        "Relationship overthinking",
        "Stress after criticism",
        "Social comparison",
  ...
  zh: {
    ...
    home: {
      ...
      subtitle:
        "InnerLeaf 会把强烈的情绪时刻整理成结构化反思卡片，帮助你区分事实和解读，选择一个小的下一步，并在长期记录中看见重复模式。",
      safety: "不是治疗，不做诊断，也不提供医疗建议。",
