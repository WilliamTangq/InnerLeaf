...
import { motionEase, softSection, staggerContainer, staggerItem } from "./lib/motion";
...
function Surface({
  ...
  return (
    <div
      className={[
        "rounded-[1.85rem] border border-[rgba(35,70,55,0.085)] bg-[rgba(255,254,248,0.84)] shadow-[var(--shadow-md)] backdrop-blur-xl transition duration-300 ease-[var(--motion-ease)]",
        className,
      ]
        .filter(Boolean)
        .join(" ")}
...
function TransformationMockup() {
  ...
  return (
    <div className="relative lg:pl-3 xl:pl-6">
      <div
        aria-hidden="true"
        className="absolute -inset-8 rounded-[3rem] bg-[radial-gradient(circle_at_82%_12%,rgba(217,179,74,0.10),transparent_32%),radial-gradient(circle_at_8%_82%,rgba(31,155,143,0.12),transparent_44%)] blur-3xl"
      />
      <Surface className="relative overflow-hidden rounded-[2.2rem] p-3.5 shadow-[0_24px_76px_rgba(38,56,48,0.11)] sm:p-4 lg:p-5">
        ...
        <div className="rounded-[1.75rem] border border-[rgba(35,70,55,0.085)] bg-[rgba(255,254,248,0.74)] p-3.5 shadow-[var(--shadow-soft)] sm:p-4">
          <div className="rounded-[1.35rem] border border-[rgba(35,70,55,0.075)] bg-[rgba(255,254,248,0.90)] p-4 shadow-[0_12px_34px_rgba(38,56,48,0.07)]">
          ...
          <div className="rounded-[1.55rem] border border-[rgba(35,70,55,0.10)] bg-[rgba(255,255,255,0.88)] p-4 shadow-[0_16px_44px_rgba(38,56,48,0.09)] sm:p-5">
            ...
            <div className="grid gap-2.5 sm:grid-cols-2">
              {cardRows.map(([label, value], index) => (
                <div
                  key={label}
                  className="soft-reveal rounded-[1.05rem] border border-[rgba(35,70,55,0.07)] bg-[rgba(246,242,233,0.48)] p-3 shadow-[var(--shadow-sm)]"
...
function ProductTransformation() {
  ...
  return (
    <motion.section {...softSection} className="mx-auto max-w-[1240px]">
      ...
      <motion.div
        {...staggerContainer}
        className="mt-8 grid gap-4 lg:grid-cols-3 lg:gap-5 xl:gap-6"
      >
  ...
  return (
    <PageShell maxWidth="max-w-[1320px]">
      <div className="h-px overflow-hidden text-[1px] leading-none text-transparent">
        <h1>See the pattern behind your emotional reactions.</h1>
          ...
          {t.home.howCards.map(([title, body], index) => {
            ...
            return (
              <motion.div key={title} {...staggerItem}>
                <Surface className="p-5 transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_22px_68px_rgba(38,56,48,0.10)] sm:p-6">
      ...
      >
        ...
        <motion.div
          {...staggerContainer}
          className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-[1.1fr_1.1fr_0.95fr_0.95fr_0.95fr]"
        >
          {t.home.pathCards.map(([title, body], index) => {
            ...
            return (
              <motion.div key={title} {...staggerItem}>
                <Surface
                  className={[
                    "h-full p-5 transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_22px_68px_rgba(38,56,48,0.10)]",
            ...
            <div className="grid gap-3">
              {t.home.differences.map(([title, body], index) => {
                ...
                return (
                  <div
                    key={title}
                    className="flex gap-4 rounded-[1.5rem] border border-[rgba(35,70,55,0.09)] bg-[rgba(247,246,243,0.58)] p-4 shadow-[var(--shadow-sm)] transition duration-300 ease-[var(--motion-ease)] hover:-translate-y-0.5 hover:bg-[rgba(255,254,248,0.74)] hover:shadow-[var(--shadow-soft)]"
                  >
      ...
      <motion.section {...softSection} className="mt-16 sm:mt-20 lg:mt-24">
        <Surface className="overflow-hidden p-6 sm:p-8 lg:p-10">
            ...
            <div className="grid gap-3">
              {t.home.patternCards.map(([title, body], index) => {
                ...
                return (
                  <div
                    key={title}
                    className="flex gap-4 rounded-2xl border border-[rgba(35,70,55,0.10)] bg-[rgba(247,246,243,0.68)] p-4 shadow-[var(--shadow-sm)] transition duration-300 ease-[var(--motion-ease)] hover:-translate-y-0.5 hover:bg-[rgba(255,254,248,0.76)] hover:shadow-[var(--shadow-soft)]"
                  >
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              {t.home.trustCards.map((item, index) => {
                ...
                return (
                  <div
                    key={item}
                    className="rounded-2xl border border-[rgba(35,70,55,0.10)] bg-[rgba(247,246,243,0.68)] p-4 text-sm font-medium leading-6 text-[var(--foreground-muted)] shadow-[var(--shadow-sm)] transition duration-300 ease-[var(--motion-ease)] hover:-translate-y-0.5 hover:bg-[rgba(255,254,248,0.76)] hover:shadow-[var(--shadow-soft)]"
                  >
      ...
      <motion.section
        {...softSection}
        className="mx-auto mb-12 mt-16 max-w-5xl rounded-[2rem] border border-[rgba(35,70,55,0.10)] bg-[linear-gradient(135deg,rgba(255,255,248,0.92),rgba(232,246,241,0.66))] p-5 shadow-[0_24px_88px_rgba(26,34,32,0.09)] backdrop-blur-xl sm:mb-16 sm:mt-20 sm:rounded-[2.35rem] sm:p-8 lg:mt-24"
      >
